...
grammarRb = """
        ...
        ?expre: "def" var parameter sentence+ "end" 
            | "/comment" comment* "uncomment/"
            | var "=" arithmeticoperation
            | var "="  string 
            | var "(" arithmeticoperation ")"
            | "def" var "(" parameter ")" sentence+ "end"        
            | function
            | "(" arithmeticoperation ")" 	
            | "puts" "(" toprint* ")"
            | "puts" toprint 
        ...
        //Definir sentencia
        ?sentence: "if" boolean
            | "if" (comparisonoperation | logicoperation) sentence+ "end" else?
            | "while" (boolean | comparisonoperation | logicoperation) sentence+ "end"
            | "for" var "in" arithhmeticoperationatom ".." arithhmeticoperationatom "do" sentence+ "end" 	
