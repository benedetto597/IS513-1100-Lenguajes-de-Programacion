...
"""
    ...
    * Lenguaje Aceptado ---> JavaScript.
    * Funcione nombradas en la grámatica de JavaScript
    * Guardado de variables, argumentos y funciones.
    * Permite la ejecución de código interpretado, dentro o fuera de una función.
    * Uso del árbol generado por Lark para la obtención del código interpretado.
    * Control de errores como falta de parametros en el llamado de una función.
    * Para la interpretación de las funciones:
    ...
    ? 7. Optimizado para manejar n cantidad de funciones.
...
class Semantic(Transformer):
    ...
    def addfunction(self,param):
        ...
        self.variables[array[0]] = self.varFunct
        self.varFunct = {}
...
#======================Resultado recursividad====================
  ...
  #===========Verificacion en caso de inexistencia de variable, verificar en los parametros=============      
    ...
    @v_args(inline=True)    
    def gettrue(self,param):
        self.varFunct[param] = "true" 

     
    def getfalse(self,param):
        self.varFunct[param] = "false" 

     
    def getnull(self,param):
        self.varFunct[param] = "null"  
    ...
    def getstring(self,name,value):
        self.varFunct[name] = value       

    def getnum(self,name,value):
        self.varFunct[name] = value 
